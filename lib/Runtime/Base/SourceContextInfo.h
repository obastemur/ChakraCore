...
public:
    ...
    union
    {
        struct
        {
            FieldNoBarrier(CHAR_T const *) url;            // The url of the file
            FieldNoBarrier(CHAR_T const *) sourceMapUrl;   // The url of the source map, such as actual non-minified source of JS on the server.
        };
