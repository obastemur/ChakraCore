...
namespace Js
{
    ...
    struct PropertyMapKeyTraits<const PropertyRecord*>
    {
        ...
        static bool IsStringTypeHandler() {TRACE_IT(67468); return false; };
    };
    ...
    struct PropertyMapKeyTraits<JavascriptString*>
    {
        ...
        static bool IsStringTypeHandler() {TRACE_IT(67469); return true; };
    };
    ...
    public:
        ...
        virtual BOOL FindNextProperty(ScriptContext* scriptContext, BigPropertyIndex& index, JavascriptString** propertyString,
            PropertyId* propertyId, PropertyAttributes* attributes, Type* type, DynamicType *typeToEnumerate, EnumeratorFlags flagse) override;
        ...
        virtual BOOL IsSimpleDictionaryTypeHandler() const {TRACE_IT(67470);return TRUE;}
#if DBG
...
#if DBG
        virtual bool SupportsPrototypeInstances() const {TRACE_IT(67471); return true; }
#endif
