...
namespace Js
{
    ...
    public:
        ...
        virtual BOOL IsWritable() {LOGMEIN("DiagObjectModel.h] 43\n"); return !IsInDeadZone(); }
        virtual Var GetValue(BOOL fUpdated) {LOGMEIN("DiagObjectModel.h] 44\n"); return nullptr; }
        virtual BOOL IsInDeadZone() const {LOGMEIN("DiagObjectModel.h] 45\n"); return FALSE; };
    };
    ...
    public:
        ...
        virtual IDiagObjectAddress *FindPropertyAddress(PropertyId propId, bool& isConst) {LOGMEIN("DiagObjectModel.h] 59\n"); return nullptr;}
    };
    ...
    public:
        ...
        virtual BOOL SetDefaultTypeAttribute(DBGPROP_ATTRIB_FLAGS attributes) {LOGMEIN("DiagObjectModel.h] 81\n"); return FALSE; };
        virtual WeakArenaReference<IDiagObjectModelWalkerBase>* CreateWalker() = 0;
        virtual BOOL IsLocalsAsRoot() {LOGMEIN("DiagObjectModel.h] 83\n"); return FALSE; }
        virtual Var GetVarValue(BOOL fUpdated) {LOGMEIN("DiagObjectModel.h] 84\n"); return nullptr; }
        virtual IDiagObjectAddress * GetDiagAddress() {LOGMEIN("DiagObjectModel.h] 85\n"); return nullptr; }
        virtual DiagObjectModelDisplayType GetType() = 0;
        virtual bool IsFake() {LOGMEIN("DiagObjectModel.h] 87\n"); return (this->GetTypeAttribute() & DBGPROP_ATTRIB_VALUE_IS_FAKE) == DBGPROP_ATTRIB_VALUE_IS_FAKE; }
        virtual bool IsLiteralProperty() const = 0;
        virtual bool IsSymbolProperty() {LOGMEIN("DiagObjectModel.h] 89\n"); return false; }

        virtual ~IDiagObjectModelDisplay() {LOGMEIN("DiagObjectModel.h] 91\n"); /* Dummy */ }
    };
    ...
    struct DebuggerPropertyDisplayInfo
    {
        ...
        {LOGMEIN("DiagObjectModel.h] 123\n");}

        bool IsUnscoped() const {LOGMEIN("DiagObjectModel.h] 125\n"); return (flags & DebuggerPropertyDisplayInfoFlags_Unscope) != 0; }
        bool IsConst() const {LOGMEIN("DiagObjectModel.h] 126\n"); return (flags & DebuggerPropertyDisplayInfoFlags_Const) != 0; }
        bool IsInDeadZone() const {LOGMEIN("DiagObjectModel.h] 127\n"); return (flags & DebuggerPropertyDisplayInfoFlags_InDeadZone) != 0; }
    };
    ...
    public :
        ...
        {LOGMEIN("DiagObjectModel.h] 175\n");
        }

        // Defined virtual function, should be extended by type of variable scope.
        virtual void PopulateMembers() {LOGMEIN("DiagObjectModel.h] 179\n"); };
        virtual IDiagObjectAddress * GetObjectAddress(int index) {LOGMEIN("DiagObjectModel.h] 180\n"); return nullptr; }
        ...
        bool IsInGroup() const {LOGMEIN("DiagObjectModel.h] 204\n"); return (groupType != UIGroupType::UIGroupType_None && groupType != UIGroupType::UIGroupType_InnerScope); }
        bool IsWalkerForCurrentFrame() const {LOGMEIN("DiagObjectModel.h] 205\n"); return groupType == UIGroupType::UIGroupType_None; }
    ...
    protected:
        int GetMemberCount() {LOGMEIN("DiagObjectModel.h] 213\n"); return pMembersList ? pMembersList->Count() : 0; }
    ...
    {
    public:
        SlotArrayVariablesWalker(DiagStackFrame* _pFrame, Var _instance, UIGroupType _groupType, bool allowLexicalThis, bool allowSuperReference = false) : VariableWalkerBase(_pFrame, _instance, _groupType, allowLexicalThis, allowSuperReference) {LOGMEIN("DiagObjectModel.h] 243\n");}

        virtual void PopulateMembers() override;
        virtual IDiagObjectAddress * GetObjectAddress(int index) override;

        ScopeSlots GetSlotArray() {LOGMEIN("DiagObjectModel.h] 248\n");
    ...
    {
    public:
        ObjectVariablesWalker(DiagStackFrame* _pFrame, Var _instance, UIGroupType _groupType, bool allowLexicalThis, bool allowSuperReference = false) : VariableWalkerBase(_pFrame, _instance, _groupType, allowLexicalThis, allowSuperReference) {LOGMEIN("DiagObjectModel.h] 258\n");}
    ...
    {
    public:
        RootObjectVariablesWalker(DiagStackFrame* _pFrame, Var _instance, UIGroupType _groupType) : ObjectVariablesWalker(_pFrame, _instance, _groupType, /* allowLexicalThis */ false) {LOGMEIN("DiagObjectModel.h] 270\n");}
    ...
    public:
        ...
        virtual BOOL GetGroupObject(ResolvedObject* pResolvedObject) {LOGMEIN("DiagObjectModel.h] 325\n");return FALSE; }
        ...
        bool HasUserNotDefinedArguments() const {LOGMEIN("DiagObjectModel.h] 379\n"); return hasUserNotDefinedArguments; }
    private:
        bool ShouldMakeGroups() const {LOGMEIN("DiagObjectModel.h] 381\n"); return frameWalkerFlags & FW_MakeGroups; }
    ...
    public:
        ...
        virtual BOOL IsLocalsAsRoot() {LOGMEIN("DiagObjectModel.h] 401\n"); return TRUE; }
        virtual DiagObjectModelDisplayType GetType() {LOGMEIN("DiagObjectModel.h] 402\n"); return DiagObjectModelDisplayType_LocalsDisplay; }
        virtual bool IsLiteralProperty() const {LOGMEIN("DiagObjectModel.h] 403\n"); return false; }
    };
    ...
    public:
        ...
        virtual BOOL GetGroupObject(ResolvedObject* pResolvedObject)  {LOGMEIN("DiagObjectModel.h] 487\n"); return FALSE; };
    ...
    public:
        ...
        virtual DiagObjectModelDisplayType GetType() {LOGMEIN("DiagObjectModel.h] 533\n"); return DiagObjectModelDisplayType_RecyclableObjectDisplay; }
    ...
    protected:
        ...
        virtual uint32 GetNextDescriptor(uint32 currentDescriptor) {LOGMEIN("DiagObjectModel.h] 581\n"); return Js::JavascriptArray::InvalidIndex; }
    ...
    public:
        ...
        void SetOnlyWalkOwnProperties(bool set) {LOGMEIN("DiagObjectModel.h] 589\n"); fOnlyOwnProperties = set; }
    ...
    {
        RecyclableCollectionObjectWalkerPropertyData():key(nullptr), value(nullptr) {LOGMEIN("DiagObjectModel.h] 755\n"); }
        RecyclableCollectionObjectWalkerPropertyData(Var key, Var value):key(key), value(value) {LOGMEIN("DiagObjectModel.h] 756\n"); }
        Var key;
        Var value;
    };
    ...
    {
        RecyclableCollectionObjectWalkerPropertyData():value(nullptr) {LOGMEIN("DiagObjectModel.h] 764\n"); }
        RecyclableCollectionObjectWalkerPropertyData(Var value):value(value) {LOGMEIN("DiagObjectModel.h] 765\n"); }
        Var value;
    };
    ...
    {
        RecyclableCollectionObjectWalkerPropertyData():value(nullptr) {LOGMEIN("DiagObjectModel.h] 772\n"); }
        RecyclableCollectionObjectWalkerPropertyData(Var value):value(value) {LOGMEIN("DiagObjectModel.h] 773\n"); }
        Var value;
    };
    ...
    public:
        RecyclableCollectionObjectWalker(ScriptContext* scriptContext, Var instance):scriptContext(scriptContext), instance(instance), propertyList(nullptr) {LOGMEIN("DiagObjectModel.h] 790\n"); }
        virtual BOOL GetGroupObject(ResolvedObject* pResolvedObject) override;
        virtual BOOL Get(int i, ResolvedObject* pResolvedObject) override;
        virtual uint32 GetChildrenCount() override;
    };
    ...
    public:
        RecyclableCollectionObjectDisplay(ScriptContext* scriptContext, const char16* name, RecyclableCollectionObjectWalker<TData>* walker) : scriptContext(scriptContext), name(name), walker(walker) {LOGMEIN("DiagObjectModel.h] 809\n"); }
        ...
        virtual DiagObjectModelDisplayType GetType() {LOGMEIN("DiagObjectModel.h] 821\n"); return DiagObjectModelDisplayType_RecyclableCollectionObjectDisplay; }
        virtual bool IsLiteralProperty() const {LOGMEIN("DiagObjectModel.h] 822\n"); return false; }
    };
    ...
    public:
        RecyclableKeyValueDisplay(ScriptContext* scriptContext, Var key, Var value, const char16* name) : scriptContext(scriptContext), key(key), value(value), name(name) {LOGMEIN("DiagObjectModel.h] 833\n"); }
        ...
        virtual WeakArenaReference<IDiagObjectModelWalkerBase>* CreateWalker() override;
        virtual DiagObjectModelDisplayType GetType() {LOGMEIN("DiagObjectModel.h] 842\n"); return DiagObjectModelDisplayType_RecyclableKeyValueDisplay; }
        virtual bool IsLiteralProperty() const {LOGMEIN("DiagObjectModel.h] 843\n"); return false; }
    };
    ...
    public:
        RecyclableKeyValueWalker(ScriptContext* scriptContext, Var key, Var value):scriptContext(scriptContext), key(key), value(value) {LOGMEIN("DiagObjectModel.h] 853\n"); }
    ...
    {
    public:
        RecyclableSimdObjectWalker(ScriptContext* pContext, Var instance) : RecyclableObjectWalker(pContext, instance) {LOGMEIN("DiagObjectModel.h] 996\n"); }
    ...
    {
    public:
        RecyclableSimdObjectDisplay(ResolvedObject* resolvedObject) : RecyclableObjectDisplay(resolvedObject) {LOGMEIN("DiagObjectModel.h] 1021\n");};
        ...
        virtual WeakArenaReference<IDiagObjectModelWalkerBase>* CreateWalker() override;
        virtual DBGPROP_ATTRIB_FLAGS GetTypeAttribute() override { return DBGPROP_ATTRIB_VALUE_IS_EXPANDABLE | DBGPROP_ATTRIB_VALUE_IS_FAKE | DBGPROP_ATTRIB_VALUE_READONLY; }
        virtual DiagObjectModelDisplayType GetType() {LOGMEIN("DiagObjectModel.h] 1028\n"); return DiagObjectModelDisplayType_RecyclableSimdDisplay; }
    };
