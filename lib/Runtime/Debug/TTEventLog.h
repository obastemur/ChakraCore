...
namespace TTD
{
    ...
    private:
        ...
        {LOGMEIN("TTEventLog.h] 344\n");
            if(!this->m_currentReplayEventIterator.IsValid())
            {LOGMEIN("TTEventLog.h] 346\n");
