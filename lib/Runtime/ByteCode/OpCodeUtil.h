...
{
public:
    static CHAR_T const * GetOpCodeName(OpCode op);
...
private:
    ...
    static CHAR_T const * const OpCodeNames[(int)Js::OpCode::MaxByteSizedOpcodes + 1];
    static CHAR_T const * const ExtendedOpCodeNames[];
    static CHAR_T const * const BackendOpCodeNames[];
#endif
