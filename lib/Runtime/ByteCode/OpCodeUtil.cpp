...
namespace Js
{
    ...
    CHAR_T const * const OpCodeUtil::OpCodeNames[] =
    {
...
#undef DEF_OP
    ...
    CHAR_T const * const OpCodeUtil::ExtendedOpCodeNames[] =
    {
#define DEF_OP(x, y, ...) _u("") STRINGIZEW(x) _u(""),
...
#undef DEF_OP
    ...
    CHAR_T const * const OpCodeUtil::BackendOpCodeNames[] =
    {
#define DEF_OP(x, y, ...) _u("") STRINGIZEW(x) _u(""),
...
#undef DEF_OP
    ...
    CHAR_T const * OpCodeUtil::GetOpCodeName(OpCode op)
    {
