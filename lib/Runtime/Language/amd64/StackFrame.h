...
namespace Js {
    ...
    public:
        ...
        bool InitializeByFrameId(void * returnAddress, ScriptContext* scriptContext) {TRACE_IT(53331); return InitializeByReturnAddress(returnAddress, scriptContext); }
        ...
        void *GetAddressOfInstructionPointer() {TRACE_IT(53332); return this->addressOfCodeAddr; }
        bool SkipToFrame(void * returnAddress);
        void *GetFrame() const;
        size_t GetStackCheckCodeHeight() {TRACE_IT(53333); return this->stackCheckCodeHeight; }
    ...
    {
    public:
        Amd64StackFrame() : frame(nullptr), codeAddr(nullptr), stackCheckCodeHeight(0), addressOfCodeAddr(nullptr) {TRACE_IT(53334);};
        ...
        void *  GetInstructionPointer() {TRACE_IT(53335); return codeAddr; }
        void ** GetArgv(bool isCurrentContextNative = false, bool shouldCheckForNativeAddr = true) {TRACE_IT(53336); return frame + 2; } 
        void *  GetReturnAddress(bool isCurrentContextNative = false, bool shouldCheckForNativeAddr = true) {TRACE_IT(53337); return frame[1]; } 
        void *  GetAddressOfReturnAddress(bool isCurrentContextNative = false, bool shouldCheckForNativeAddr = true) {TRACE_IT(53338); return &frame[1]; } 
        void *  GetAddressOfInstructionPointer() const {TRACE_IT(53339); return addressOfCodeAddr; }
        void *  GetFrame() const {TRACE_IT(53340); return (void *)frame; }

        void SetReturnAddress(void * address) {TRACE_IT(53341); frame[1] = address; }
        bool SkipToFrame(void * frameAddress);

        size_t GetStackCheckCodeHeight() {TRACE_IT(53342); return this->stackCheckCodeHeight; }
        static bool IsInStackCheckCode(void *entry, void *codeAddr, size_t stackCheckCodeHeight);
