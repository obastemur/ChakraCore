...
namespace Js
{
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 12\n");
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 19\n");
        X86SIMDValue x86Result;
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 28\n");
        X86SIMDValue x86Result;
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 38\n");
        ...
        if (mask)
        {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 50\n");
            throws = true;
            return X86SIMDValue::ToSIMDValue(x86Result);
        }
        ...
        if (mask)
        {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 71\n");
            throws = true;
            return X86SIMDValue::ToSIMDValue(x86Result);
        }
        // we pass range check
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 93\n");
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 106\n");
        // _mm_min_epu32 is SSE4.1
        //X86SIMDValue x86Result;
        //X86SIMDValue tmpaValue = X86SIMDValue::ToX86SIMDValue(aValue);
        //X86SIMDValue tmpbValue = X86SIMDValue::ToX86SIMDValue(bValue);
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 119\n");
        X86SIMDValue x86Result;
        X86SIMDValue tmpaValue = X86SIMDValue::ToX86SIMDValue(aValue);
        X86SIMDValue tmpbValue = X86SIMDValue::ToX86SIMDValue(bValue);
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 135\n");
        X86SIMDValue x86Result;
        X86SIMDValue tmpaValue = X86SIMDValue::ToX86SIMDValue(aValue);
        X86SIMDValue tmpbValue = X86SIMDValue::ToX86SIMDValue(bValue);
        X86SIMDValue signBits;
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 153\n");
        SIMDValue result;
    ...
    {LOGMEIN("SimdUint32x4OperationX86X64.cpp] 161\n");
        SIMDValue result;
