...
#define END_PROFILED_TYPEOF_ERROR_HANDLER(scriptContext, var, functionBody, inlineCacheIndex) \
    ...
    public:
        ...
        static BOOL SetGlobalPropertyNoHost(CHAR_T const * propertyName, charcount_t propertyLength, Var value, ScriptContext * scriptContext);
        ...
        static void TraceUpdateConstructorCache(const ConstructorCache* ctorCache, const FunctionBody* ctorBody, bool updated, const CHAR_T* reason);
        ...
        static BOOL TryConvertToUInt32(const CHAR_T* str, int length, uint32* value);
