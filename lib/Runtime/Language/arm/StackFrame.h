...
namespace Js
{
    ...
    public:
        ...
        void *GetAddressOfInstructionPointer() {LOGMEIN("StackFrame.h] 48\n"); Assert(addressOfCodeAddr != nullptr); return addressOfCodeAddr; }
        ...
        void *GetFrame() {LOGMEIN("StackFrame.h] 51\n"); return (void *)frame;};
        size_t GetStackCheckCodeHeight() {LOGMEIN("StackFrame.h] 52\n"); return this->stackCheckCodeHeight; }
