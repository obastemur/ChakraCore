...
{LOGMEIN("WasmLibrary.cpp] 100\n");
    ...
    if (readerInfo)
    {LOGMEIN("WasmLibrary.cpp] 111\n");
        info->SetWasmReaderInfo(nullptr);
        try
        {LOGMEIN("WasmLibrary.cpp] 114\n");
