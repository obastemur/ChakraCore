...
namespace Js
{
    ...
    Var JavascriptSetIterator::EntryNext(RecyclableObject* function, CallInfo callInfo, ...)
    {
        ...
        {LOGMEIN("JavascriptSetIterator.cpp] 43\n");
        ...
        {LOGMEIN("JavascriptSetIterator.cpp] 52\n");
        ...
        {LOGMEIN("JavascriptSetIterator.cpp] 61\n");
