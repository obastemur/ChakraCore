...
namespace Js
{
    ...
    public:
        ...
        static uint32 GetOffsetOfValues() {TRACE_IT(64614); return offsetof(WebAssemblyTable, m_values); }
        static uint32 GetOffsetOfCurrentLength() {TRACE_IT(64615); return offsetof(WebAssemblyTable, m_currentLength); }
    private:
