...
namespace Js
{
    ...
    public:
        ...
        inline SIMDValue GetValue() {LOGMEIN("JavascriptSimdFloat32x4.h] 41\n"); return value; }
        virtual RecyclableObject * CloneToScriptContext(ScriptContext* requestContext) override;

        static size_t GetOffsetOfValue() {LOGMEIN("JavascriptSimdFloat32x4.h] 44\n"); return offsetof(JavascriptSIMDFloat32x4, value); }
