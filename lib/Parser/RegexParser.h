...
namespace UnifiedRegex
{
    ...
    class Parser : private EncodingPolicy, private Chars<CHAR_T>
    {
    private:
        ...
        // Standard characters using final character representation (eg CHAR_T for Unicode)
    ...
    private:
        ...
        Node* CreateSurrogatePairAtom(CHAR_T lower, CHAR_T upper);
