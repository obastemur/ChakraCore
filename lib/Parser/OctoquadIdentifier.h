...
namespace UnifiedRegex
{
    ...
    struct TrigramAlphabet {
        ...
        void MegaMatch(__in_ecount(inputLen) const CHAR_T* input,int inputLen);
    };
    ...
    class OctoquadIdentifier : private Chars<CHAR_T>
    {
    ...
    class OctoquadMatcher : private Chars<CHAR_T>
    {
    private:
