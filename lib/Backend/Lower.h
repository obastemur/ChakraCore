...
struct Int64RegPair
{
    IR::Opnd* high;
    IR::Opnd* low;
    Int64RegPair(): high(nullptr), low(nullptr) {TRACE_IT(12829);}
};
...
public:
    ...
    inline static IR::IntConstOpnd* MakeCallInfoConst(ushort flags, int32 argCount, Func* func) {TRACE_IT(12832);
#ifdef _M_X64
...
private:
    ...
    static const uint16  GetFormalParamOffset() {TRACE_IT(12833); /*formal start after frame pointer, return address, function object, callInfo*/ return 4;};
...
public:
    ...
    static bool DoLazyBailout(Func* func) {TRACE_IT(12836); return PHASE_ON(Js::LazyBailoutPhase, func) && !func->IsLoopBody(); }
    static bool DoLazyFixedTypeBailout(Func* func) {TRACE_IT(12837); return DoLazyBailout(func) && !PHASE_OFF(Js::LazyFixedTypeBailoutPhase, func); }
    static bool DoLazyFixedDataBailout(Func* func) {TRACE_IT(12838); return DoLazyBailout(func) && !PHASE_OFF(Js::LazyFixedDataBailoutPhase, func); }
    LowererMD * GetLowererMD() {TRACE_IT(12839); return &m_lowererMD; }
private:
    Func *          m_func;
