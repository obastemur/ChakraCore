...
public:
    ...
    void                SetIDAdjustment() {TRACE_IT(15770); m_IDAdjustment = m_currentID;}
    void                ClearIDAdjustment() {TRACE_IT(15771); m_IDAdjustment = 0; }
    SymID               MapSymID(SymID id) {TRACE_IT(15772);  return id + m_IDAdjustment; }
private:
