...
public:
    ...
    /* utility functions */
    static Js::PropertyId CreateProperty(Js::ScriptContext *scriptContext, const CHAR_T *propertyName);
    static void SetProperty(Js::DynamicObject *obj, const CHAR_T *propertyName, Js::Var value);
    static void SetProperty(Js::DynamicObject *obj, Js::PropertyId id, Js::Var value);
    static void GetStatementSourceString(__out_ecount(len) CHAR_T *buffer, LPCUTF8 sourceBegin, LPCUTF8 sourceEnd, const size_t len);
