...
#define TYPED_SLOT_INFO_GETTER(name, type) \
    int Get##name##ByteOffset() const   {TRACE_IT(40); return m_data.typedSlotInfos[WAsmJs::##type].byteOffset; }\
    int Get##name##ConstCount() const   {TRACE_IT(41); return m_data.typedSlotInfos[WAsmJs::##type].constCount; }\
    int Get##name##TmpCount() const     {TRACE_IT(42); return m_data.typedSlotInfos[WAsmJs::##type].tmpCount; }\
    int Get##name##VarCount() const     {TRACE_IT(43); return m_data.typedSlotInfos[WAsmJs::##type].varCount; }
