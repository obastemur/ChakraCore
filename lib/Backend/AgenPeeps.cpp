...
{LOGMEIN("AgenPeeps.cpp] 79\n");
    ...
    {LOGMEIN("AgenPeeps.cpp] 90\n");
        if (instr == blockStart || (bound > 0 && i == bound))
        {LOGMEIN("AgenPeeps.cpp] 92\n");
