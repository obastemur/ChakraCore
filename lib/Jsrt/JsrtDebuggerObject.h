...
public:
    ...
    bool Evaluate(Js::ScriptContext* scriptContext, const CHAR_T *source, int sourceLength, bool isLibraryCode, bool forceSetValueProp, Js::DynamicObject** evalResult);
