...
public :
    ...
    static LPCCHAR_T JsErrorCodeToString(JsErrorCode jsErrorCode);
    static void LogError(__in __nullterminated const CHAR_T *msg, ...);
    ...
    static void CreateTTDDirectoryAsNeeded(size_t* uriLength, char* uri, const char* asciiDir1, const CHAR_T* asciiDir2);
    static void GetTTDDirectory(const CHAR_T* curi, size_t* uriLength, char* uri, size_t bufferLength);
