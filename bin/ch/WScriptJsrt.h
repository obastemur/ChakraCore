...
public:
    ...
    static JsValueRef __stdcall EchoCallback(FILE *file, JsValueRef callee, bool isConstructCall, JsValueRef *arguments, unsigned short argumentCount, void *callbackState);
